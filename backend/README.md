...
## Project Structure
    ...
    ├── testapiautoconnecto_54738  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_54738`
...
2. Clone this repo and `cd testapiautoconnecto_54738`
